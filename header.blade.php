...
<head>
    ...
    <title>AdmindLTE 2 | Starter</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-lg"><b>BOOKOTOPIA</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="/author"><i class="fa fa-link"></i> <span>Author</span></a></li>
                <li><a href="/category"><i class="fa fa-link"></i> <span>Category</span></a></li>
                <li><a href="/librarian"><i class="fa fa-link"></i> <span>Librarian</span></a></li>
                <li><a href="/dashboard/magazine"><i class="fa fa-link"></i> <span>Magazine</span></a></li>
                <li><a href="/dashboard/category_magazine"><i class="fa fa-link"></i> <span>Category_Magazine</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
